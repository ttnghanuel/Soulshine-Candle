    ...
    <div className="home-page">
      ...
      <div className="home-page__introduction d-flex">
        ...
        <div className="home-page__introduction__right d-flex flex-column justify-content-end justify-content-xl-center pb-5 pb-xl-0">
          ...
          <button className="text-uppercase btn-ss font-cormorant rounded-pill fw-400">
            Discover Products
          </button>
        </div>
      </div>
      <div className="home-page__trending container">
        ...
        <div className="row gx-4">
          {productList.map((item, index) => {
            ...
            return (
              <div key={index} className="col-12 col-sm-6 col-lg-3 px-4 py-3 py-lg-0">
                <ProductCard {...item} />
              </div>
            );
          })}
      ...
      <div className="home-page__find-product position-relative">
        <img
          ...
          alt=""
        />
        <button className="btn-ss text-uppercase rounded-pill font-cormorant fw-400">
          Find product
        </button>
      </div>
