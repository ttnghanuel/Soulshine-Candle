              ...
              <div className="checkout-page__left">
                ...
                {quantity > 0 ? (
                  <>
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="checkout-page__product-item__text">
                            <h6 className="mb-0 text-dark fw-700 font-cormorant">
                              {item.productName}
                            </h6>
                    ...
                    <div className="row gx-5 checkout-page__note">
                      <div className="col-6">
                        <div className="checkout-page__note__left">
                          <p className="text-ss fw-400 font-cormorant">Order note</p>
                          <textarea
                            rows="10"
                            className="w-100 text-black-50 font-open-sans p-2"
                          ></textarea>
                        </div>
                      </div>
                      <div className="col-6">
