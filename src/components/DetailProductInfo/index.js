...
import "./detail-product-info.css";
  ...
  return (
    <div className="detail-product-info">
      ...
      <div className="detail-product-info__rating d-flex align-items-center">
        ...
        <span className="font-cormorant text-dark fw-400">
          {reviews} {reviews > 1 ? "review" : "reviews"}
        </span>
      </div>
      <p className="detail-product-info__rating font-cormorant fw-400 text-dark">{description}</p>
      ...
      <div className="detail-product-info__description">
        ...
        <p className="mb-0 text-dark font-open-sans fw-300">
          Lorem ipsum, dolor sit amet consectetur adipisicing elit. Rem veniam eos sunt quo at omnis
          nulla ipsa a ad, quas aspernatur consequuntur iste quaerat perferendis laboriosam
          repudiandae odio. Excepturi, similique!
        </p>
      </div>
      <div className="detail-product-info__ingredients">
        ...
        <p className="mb-0 text-dark font-open-sans fw-300">
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Earum officia at enim voluptatum
          debitis repellat qui libero. Eius aliquam nulla sit ipsum, dolorem cupiditate quae sunt
          dolor. Ut, cupiditate rem!
        </p>
      </div>
